...
def add_eval_args(parser: argparse.ArgumentParser):
    group = parser.add_argument_group('eval', 'eval configuration')
    group.add_argument('--candidate-file', type=str, default=None)
    group.add_argument('--candidate-num', type=int, default=16)
    return parser
...
def add_training_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument('--data-path', type=str, default=None, help='Path to dataset path')
